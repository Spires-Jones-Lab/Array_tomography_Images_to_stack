...
run("Images to Stack", "method=[Copy (center)] name=channel_2 title=[C=1] use");  
selectWindow("channel_2");
saveAs("Tiff", output + ""+name+"_syph");

run("Images to Stack", "method=[Copy (center)] name=channel_3 title=[C=2] use");  
selectWindow("channel_3");
saveAs("Tiff", output + ""+name+"_oc");

run("Images to Stack", "method=[Copy (center)] name=channel_4 title=[C=3] use");  
selectWindow("channel_4");
saveAs("Tiff", output + ""+name+"_tau");
//-------------------------------------------------------------------------------------------------------
